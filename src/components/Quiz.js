                    ...
                    <div className="col-lg-8">
                        <div className="card p-4" style={{ background: '#3d3d3d', borderColor: '#646464' }}>
                            <div className="d-flex justify-content-between gap-md-3">
                                ...
                                <h5 style={{ color: '#60d600', width: '120px', textAlign: 'right', marginTop: '3px' }}>
                            ...
                            {questionIndex + 1 !== quizs.length ? (
                                <>
                                    <div className="d-flex justify-content-center mt-3">
                                        <button
                                            className="btn py-2 w-100 bg-primary text-light fw-bold"
                                    ...
                                    <div className="d-flex justify-content-center">
                                        <button className="btn py-2 w-100  text-light fw-bold mt-3" style={{ backgroundColor: "#c52222" }} onClick={chooseQuiz}>
                                            Exit
                                        </button>
                                    </div>
                                </>
